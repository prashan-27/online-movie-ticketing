...
if (isset($_POST['submit'])) {
    $amount = (int)$_POST['inputAmount4'] * 100; // convert the amount to paisa as the amount should be in paisa for khalti
    ...
    if(empty($amount) || empty($purchase_order_id) || empty($purchase_order_name) || empty($name) || empty($email) || empty($phone)){
        ...
        if (isset($_POST['submit'])) {
            ...
            $postFields = array(
                "return_url" => "http://localhost/6th/payment_response.php",
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                'Authorization: key d5cb45f2f146454bbeebabcca81781bd',
